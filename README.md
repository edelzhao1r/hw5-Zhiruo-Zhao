...
- Accounting-format preprocessing (`"1,000"` and `(200)` bracket notation) is handled before numeric coercion
...
- Corrective suggestions are generated by the model based on audit findings and may not always reflect the correct accounting treatmen. The user should verify before acting
